...
Basic social media app to show posts

## Description

<p>
This application is a very basic social media app to learn CRUD principles with JavaScript.

This allows the user to add a post, edit a post, and delete a post.
</p>
